...
// Aggregated Monitoring view for the /llms landing area: same widgets as the per-LLM Monitoring
// tab but summed across every LLM the current identity has Read access on. No LLM selector — to
// drill into a single LLM, the user clicks it in the sidebar and uses the existing detail page.
const AggregatedMonitorPanel = () => {
  ...
  // No llm.destination seed in aggregated mode — model options fill from ModelSpends data as it
  // loads. Empty until first response; documented UX seam.
  ...
  return (
    <div className="flex flex-col w-full gap-4 h-full overflow-auto p-5">
      <h1 className="text-2xl font-bold">{t('LLMs Monitoring')}</h1>
...
export default AggregatedMonitorPanel;
