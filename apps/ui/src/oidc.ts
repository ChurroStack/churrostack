...
bootstrapOidc(
  import.meta.env.VITE_OIDC_USE_MOCK === 'true'
    ...
    : {
        ...
        issuerUri:
          (window as any).__ENV__.VITE_OIDC_ISSUER_URI[0] === '$'
            ? import.meta.env.VITE_OIDC_ISSUER_URI
            : (window as any).__ENV__.VITE_OIDC_ISSUER_URI,
        clientId: import.meta.env.VITE_OIDC_CLIENT_ID,
        scopes: import.meta.env.VITE_OIDC_SCOPES?.split(' ') ?? [],
        debugLogs: true
      }
);
