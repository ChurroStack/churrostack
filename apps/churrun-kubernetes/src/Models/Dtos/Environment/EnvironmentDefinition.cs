namespace ChurrunKubernetes.Models.Dtos.Environment
{
    public class EnvironmentDefinition
    {
        ...
        public EnvironmentDefinition(string name, string basePath, Dictionary<string, string> capabilities, string description, QuotaDefinition? limits, SizeDefinition[]? sizes, IDictionary<string, string>? translation)
        {
            Name = name;
            BasePath = basePath;
