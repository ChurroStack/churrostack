...
{
    public class EnvironmentSizeDefinition
    {
        /// <summary>
        ...
        /// </summary>
        public EnvironmentQuotaDefinition? Requests { get; set; }
        ...
        public EnvironmentSizeDefinition(string name, string title, string? description, EnvironmentQuotaDefinition? requests, EnvironmentQuotaDefinition? limits, IDictionary<string, string>? translation)
        {
            Name = name;
            Title = title;
