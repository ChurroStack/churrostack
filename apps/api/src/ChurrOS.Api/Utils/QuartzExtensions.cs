...
namespace ChurrOS.Api.Utils
{
    public static class QuartzExtensions
    {
        ...
        public static async Task ApplyQuartzTables(this ChurrosDbContext context)
        {
            var schemaExists = await context.ExecuteScalarAsync<bool>("""
                SELECT EXISTS (
                    SELECT 1
