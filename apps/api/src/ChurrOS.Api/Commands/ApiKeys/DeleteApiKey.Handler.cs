...
{
    public class DeleteApiKeyHandler : IRequestHandler<DeleteApiKey, Task>
    {
        private readonly ChurrosDbContext _context;
        private readonly IMediator _mediator;

        public DeleteApiKeyHandler(ChurrosDbContext context, IMediator mediator)
        {
            _context = context;
            _mediator = mediator;
        }

        public async Task Handle(DeleteApiKey request, CancellationToken cancellationToken)
        {
            ...
            _context.Set<Domain.ApiKey>().Remove(apiKey);
